...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.Unsigned16BitIntegerBuf
//
...
import benchmarks.determinism.pj.edu.ritmp.buf.EmptyUnsigned16BitIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned16BitIntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned16BitIntegerArrayBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned16BitIntegerItemBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned16BitIntegerMatrixBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned16BitIntegerMatrixBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned16BitIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned16BitIntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned16BitIntegerArrayBuf_1;
...
// Hidden constructors.
	 ...
	 */
	protected Unsigned16BitIntegerBuf
		(int theLength)
		{
...
// Exported operations.
	 ...
	 */
	public static Unsigned16BitIntegerBuf buffer
		(int[] theArray)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.buffer(): theArray is null");
			}
	 ...
	 */
	public static Unsigned16BitIntegerBuf sliceBuffer
		(int[] theArray,
		 Range theRange)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.sliceBuffer(): theArray is null");
			}
		int nr = Arrays.length (theArray);
		if (0 > theRange.lb() || theRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned16BitIntegerBuf.sliceBuffer(): theArray index range = 0.." +
	 ...
	 */
	public static Unsigned16BitIntegerBuf[] sliceBuffers
		(int[] theArray,
		 Range[] theRanges)
		{
	...
	public static Unsigned16BitIntegerBuf buffer
		...
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.buffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		int nc = Arrays.colLength (theMatrix, 0);
		return new Unsigned16BitIntegerMatrixBuf_1
	 ...
	 */
	public static Unsigned16BitIntegerBuf rowSliceBuffer
		(int[][] theMatrix,
		 Range theRowRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.rowSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned16BitIntegerBuf.rowSliceBuffer(): theMatrix row index range = 0.." +
		...
		if (theRowRange.stride() == 1)
			...
			{
			return new Unsigned16BitIntegerMatrixBuf
				(theMatrix, theRowRange, new Range (0, nc-1));
			}
		}
	 ...
	 */
	public static Unsigned16BitIntegerBuf[] rowSliceBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges)
		{
	 ...
	 */
	public static Unsigned16BitIntegerBuf colSliceBuffer
		(int[][] theMatrix,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.colSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		int nc = Arrays.colLength (theMatrix, 0);
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("Unsigned16BitIntegerBuf.colSliceBuffer(): theMatrix column index range = 0.."
	 ...
	 */
	public static Unsigned16BitIntegerBuf[] colSliceBuffers
		(int[][] theMatrix,
		 Range[] theColRanges)
		{
	 ...
	 */
	public static Unsigned16BitIntegerBuf patchBuffer
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.patchBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned16BitIntegerBuf.patchBuffer(): theMatrix row index range = 0.."
				 + (nr-1) + ", theRowRange = " + theRowRange);
			}
		int nc = Arrays.colLength (theMatrix, theRowRange.lb());
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("Unsigned16BitIntegerBuf.patchBuffer(): theMatrix column index range = 0.."
				 + (nc-1) + ", theColRange = " + theColRange);
			}
	 ...
	 *     <TT>theColRanges</TT>.
	 */
	public static Unsigned16BitIntegerBuf[] patchBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges,
		 Range[] theColRanges)
		{
	...
	public static Unsigned16BitIntegerBuf buffer
		...
		if (item == null)
			{
			throw new NullPointerException
				("Unsigned16BitIntegerBuf.buffer(): item is null");
			}
...
// Hidden operations.
	...
	protected static void defaultCopy
		(Unsigned16BitIntegerBuf theSrc,

//******************************************************************************
//
// File:    SharedDoubleArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedDoubleArrayReductionBuf_1
//
...
/**
 * Class SharedDoubleArrayReductionBuf_1 provides a reduction buffer for
 * class {@linkplain SharedDoubleArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedDoubleArrayReductionBuf_1
	extends SharedDoubleArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared double array reduction buffer.
	 *
	 ...
	 */
	public SharedDoubleArrayReductionBuf_1
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedDoubleArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}

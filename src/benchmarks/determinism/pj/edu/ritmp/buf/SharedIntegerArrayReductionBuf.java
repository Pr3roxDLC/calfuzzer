//******************************************************************************
//
// File:    SharedIntegerArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerArrayReductionBuf
//
...
/**
 * Class SharedIntegerArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedIntegerArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedIntegerArrayReductionBuf
	extends SharedIntegerArrayBuf
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared integer array reduction buffer.
	 *
	 ...
	 */
	public SharedIntegerArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedIntegerArrayReductionBuf(): op is null");
			}
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 4)
			{
			myArray.reduce (off, buffer.getInt(), myOp);
			++ index;
			off += myStride;
			}
		return index - i;

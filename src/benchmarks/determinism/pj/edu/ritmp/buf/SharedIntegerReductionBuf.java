//******************************************************************************
//
// File:    SharedIntegerReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerReductionBuf
//
...
/**
 * Class SharedIntegerReductionBuf provides a reduction buffer for class
 * {@linkplain SharedIntegerBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedIntegerReductionBuf
	extends SharedIntegerBuf
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared integer reduction buffer.
	 *
	 ...
	 */
	public SharedIntegerReductionBuf
		(SharedInteger item,
		 IntegerOp op)
		{
		super (item);
		if (op == null)
			...
			throw new NullPointerException
				("SharedIntegerReductionBuf(): op is null");
			}
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		if (num >= 1 && buffer.remaining() >= 4)
			{
			myItem.reduce (buffer.getInt(), myOp);
			return 1;
			}
		else
			{

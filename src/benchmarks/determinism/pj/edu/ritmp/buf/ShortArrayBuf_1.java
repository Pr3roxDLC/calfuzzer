//******************************************************************************
//
// File:    ShortArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ShortArrayBuf_1
//
 ...
 * must be 1. While an instance of class ShortArrayBuf may be constructed
 * directly, normally you will use a factory method in class {@linkplain
 * benchmarks.determinism.pj.edu.ritmp.ShortBuf ShortBuf}. See that class for further
 * information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new ShortArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int receiveItems
		...
		ShortBuffer shortbuffer = buffer.asShortBuffer();
		int n = Math.min
			(num, Math.min (myLength - i, shortbuffer.remaining()));
		shortbuffer.get (myArray, myArrayOffset + i, n);
		buffer.position (buffer.position() + 2*n);
		return n;
		}

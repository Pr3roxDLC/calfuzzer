//******************************************************************************
//
// File:    SharedIntegerArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerArrayReductionBuf_1
//
 ...
 * class {@linkplain SharedIntegerArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedIntegerArrayReductionBuf_1
	extends SharedIntegerArrayBuf_1
	{
...
// Exported constructors.
	 ...
	 */
	public SharedIntegerArrayReductionBuf_1
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedIntegerArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}

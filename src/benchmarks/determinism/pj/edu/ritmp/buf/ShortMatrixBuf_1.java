//******************************************************************************
//
// File:    ShortMatrixBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ShortMatrixBuf_1
//
 ...
 * strides must both be 1. While an instance of class ShortMatrixBuf_1 may
 * be constructed directly, normally you will use a factory method in class
 * {@linkplain benchmarks.determinism.pj.edu.ritmp.ShortBuf ShortBuf}. See that class for further
 * information.
 *
 * @author  Alan Kaminsky
 * @version 03-Mar-2008
 */
public class ShortMatrixBuf_1
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new ShortMatrixReductionBuf_1
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (r < myRowCount && ncols > 0)
			{
			shortbuffer.get (myMatrix[row], col, ncols);
			n += ncols;
			++ r;
			++ row;
			c = 0;

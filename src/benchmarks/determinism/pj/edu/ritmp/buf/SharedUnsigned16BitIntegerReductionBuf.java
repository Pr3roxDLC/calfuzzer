...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned16BitIntegerReductionBuf
//
...
// Exported constructors.
	 ...
	 */
	public SharedUnsigned16BitIntegerReductionBuf
		(SharedInteger item,
		 IntegerOp op)
		{
		super (item);
		if (op == null)
			...
			throw new NullPointerException
				("SharedUnsigned16BitIntegerReductionBuf(): op is null");
			}
		myOp = op;
		}

//******************************************************************************
//
// File:    Signed16BitIntegerArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed16BitIntegerArrayBuf_1
//
 ...
 * Signed16BitIntegerArrayBuf_1 may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.Signed16BitIntegerBuf
 * Signed16BitIntegerBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class Signed16BitIntegerArrayBuf_1
	extends Signed16BitIntegerArrayBuf
	{
...
// Exported constructors.
	 ...
	 */
	public Signed16BitIntegerArrayBuf_1
		(int[] theArray,
		 Range theRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed16BitIntegerArrayReductionBuf_1

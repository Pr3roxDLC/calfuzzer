//******************************************************************************
//
// File:    SharedByteArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedByteArrayBuf_1
//
...
/**
 * Class SharedByteArrayBuf_1 provides a buffer for a multiple thread safe
 * array of byte items sent or received using the Message Protocol (MP). The
 * array element stride must be 1. While an instance of class
 * SharedByteArrayBuf_1 may be constructed directly, normally you will use a
 * factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.ByteBuf ByteBuf}. See
 * that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class SharedByteArrayBuf_1
	extends SharedByteArrayBuf
	{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedByteArrayReductionBuf_1
			(myArray, myRange, (ByteOp) op);
		}

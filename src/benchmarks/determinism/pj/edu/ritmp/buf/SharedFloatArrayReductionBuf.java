//******************************************************************************
//
// File:    SharedFloatArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedFloatArrayReductionBuf
//
...
/**
 * Class SharedFloatArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedFloatArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public SharedFloatArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedFloatArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

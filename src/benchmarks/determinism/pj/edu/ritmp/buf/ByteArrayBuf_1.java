//******************************************************************************
//
// File:    ByteArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.ByteArrayBuf_1
//
 ...
 * While an instance of class ByteArrayBuf may be constructed directly, normally
 * you will use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.ByteBuf
 * ByteBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 25-Oct-2007
 */
public class ByteArrayBuf_1
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new ByteArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int sendItems
		(int i,
		 ByteBuffer buffer)
		{
		int n = Math.min (myLength - i, buffer.remaining());
		buffer.put (myArray, myArrayOffset + i, n);
		return n;
		}
	...
	protected int receiveItems
		(int i,
		 ...
		 ByteBuffer buffer)
		{
		int n = Math.min (num, Math.min (myLength - i, buffer.remaining()));
		buffer.get (myArray, myArrayOffset + i, n);
		return n;
		}

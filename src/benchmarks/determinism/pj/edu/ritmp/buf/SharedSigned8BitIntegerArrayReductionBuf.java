//******************************************************************************
//
// File:    SharedSigned8BitIntegerArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned8BitIntegerArrayReductionBuf
//
...
/**
 * Class SharedSigned8BitIntegerArrayReductionBuf provides a reduction buffer
 * for class {@linkplain SharedSigned8BitIntegerArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public SharedSigned8BitIntegerArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedSigned8BitIntegerArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

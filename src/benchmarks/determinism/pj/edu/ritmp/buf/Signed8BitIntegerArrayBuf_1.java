//******************************************************************************
//
// File:    Signed8BitIntegerArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Signed8BitIntegerArrayBuf_1
//
 ...
 * 8-bit integer items sent or received using the Message Protocol (MP). The
 * array element stride must be 1. While an instance of class
 * Signed8BitIntegerArrayBuf_1 may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.Signed8BitIntegerBuf
 * Signed8BitIntegerBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class Signed8BitIntegerArrayBuf_1
	extends Signed8BitIntegerArrayBuf
	{
...
// Exported constructors.
	 ...
	 */
	public Signed8BitIntegerArrayBuf_1
		(int[] theArray,
		 Range theRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Signed8BitIntegerArrayReductionBuf_1

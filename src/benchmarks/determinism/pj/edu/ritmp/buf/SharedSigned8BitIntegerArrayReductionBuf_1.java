//******************************************************************************
//
// File:    SharedSigned8BitIntegerArrayReductionBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned8BitIntegerArrayReductionBuf_1
//
...
/**
 * Class SharedSigned8BitIntegerArrayReductionBuf_1 provides a reduction buffer
 * for class {@linkplain SharedSigned8BitIntegerArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedSigned8BitIntegerArrayReductionBuf_1
	extends SharedSigned8BitIntegerArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared signed 8-bit integer array reduction buffer.
	 *
	 ...
	 */
	public SharedSigned8BitIntegerArrayReductionBuf_1
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedSigned8BitIntegerArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}

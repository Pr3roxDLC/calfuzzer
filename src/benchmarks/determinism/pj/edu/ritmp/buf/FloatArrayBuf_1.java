...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.FloatArrayBuf_1
//
...
/**
 * Class FloatArrayBuf_1 provides a buffer for an array of float items
 * sent or received using the Message Protocol (MP). The array element stride
 * must be 1. While an instance of class FloatArrayBuf may be constructed
 * directly, normally you will use a factory method in class {@linkplain
 * benchmarks.determinism.pj.edu.ritmp.FloatBuf FloatBuf}. See that class for further
 * information.
 *
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new FloatArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int receiveItems
		...
		FloatBuffer floatbuffer = buffer.asFloatBuffer();
		int n = Math.min
			(num, Math.min (myLength - i, floatbuffer.remaining()));

//******************************************************************************
//
// File:    SharedBooleanArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedBooleanArrayReductionBuf
//
...
/**
 * Class SharedBooleanArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedBooleanArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public SharedBooleanArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedBooleanArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

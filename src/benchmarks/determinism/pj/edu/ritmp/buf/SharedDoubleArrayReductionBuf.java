//******************************************************************************
//
// File:    SharedDoubleArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedDoubleArrayReductionBuf
//
...
/**
 * Class SharedDoubleArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedDoubleArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public SharedDoubleArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedDoubleArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

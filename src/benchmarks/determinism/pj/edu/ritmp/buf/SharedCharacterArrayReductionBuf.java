//******************************************************************************
//
// File:    SharedCharacterArrayReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedCharacterArrayReductionBuf
//
...
/**
 * Class SharedCharacterArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedCharacterArrayBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedCharacterArrayReductionBuf
...
// Exported constructors.
	 ...
	 */
	public SharedCharacterArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedCharacterArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

//******************************************************************************
//
// File:    SharedSigned16BitIntegerArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned16BitIntegerArrayBuf_1
//
 ...
 * Message Protocol (MP). The array element stride must be 1. While an instance
 * of class SharedSigned16BitIntegerArrayBuf_1 may be constructed directly,
 * normally you will use a factory method in class {@linkplain
 * benchmarks.determinism.pj.edu.ritmp.Signed16BitIntegerBuf Signed16BitIntegerBuf}. See that class for
 * further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class SharedSigned16BitIntegerArrayBuf_1
	extends SharedSigned16BitIntegerArrayBuf
	{
...
// Exported constructors.
	 ...
	 */
	public SharedSigned16BitIntegerArrayBuf_1
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedSigned16BitIntegerArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 2)
			{
			myArray.set (off, buffer.getShort());
			++ index;
			++ off;
			}
		return index - i;

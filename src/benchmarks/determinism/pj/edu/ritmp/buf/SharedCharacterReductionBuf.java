//******************************************************************************
//
// File:    SharedCharacterReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedCharacterReductionBuf
//
 ...
 * {@linkplain SharedCharacterBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedCharacterReductionBuf
	extends SharedCharacterBuf
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared character reduction buffer.
	 *
	 ...
	 */
	public SharedCharacterReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedCharacterReductionBuf(): op is null");
			}
		myOp = op;
		}
...
// Hidden operations.
	...
	protected int receiveItems
		...
		if (num >= 1 && buffer.remaining() >= 2)
			{
			myItem.reduce (buffer.getChar(), myOp);
			return 1;
			}
		else
			{

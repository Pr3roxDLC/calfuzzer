//******************************************************************************
//
// File:    Unsigned8BitIntegerArrayBuf_1.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerArrayBuf_1
//
 ...
 * (MP). The array element stride must be 1. While an instance of class
 * Unsigned8BitIntegerArrayBuf_1 may be constructed directly, normally you will
 * use a factory method in class {@linkplain benchmarks.determinism.pj.edu.ritmp.Unsigned8BitIntegerBuf
 * Unsigned8BitIntegerBuf}. See that class for further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class Unsigned8BitIntegerArrayBuf_1
...
// Exported constructors.
	 ...
	 */
	public Unsigned8BitIntegerArrayBuf_1
		(int[] theArray,
		 Range theRange)
		{
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new Unsigned8BitIntegerArrayReductionBuf_1

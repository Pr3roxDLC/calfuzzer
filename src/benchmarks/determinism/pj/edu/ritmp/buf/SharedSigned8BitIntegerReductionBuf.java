//******************************************************************************
//
// File:    SharedSigned8BitIntegerReductionBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp.buf
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.buf.SharedSigned8BitIntegerReductionBuf
//
...
/**
 * Class SharedSigned8BitIntegerReductionBuf provides a reduction buffer for
 * class {@linkplain SharedSigned8BitIntegerBuf}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedSigned8BitIntegerReductionBuf
	extends SharedSigned8BitIntegerBuf
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared signed 8-bit integer reduction buffer.
	 *
	 ...
	 */
	public SharedSigned8BitIntegerReductionBuf
		(SharedInteger item,
		 IntegerOp op)
		{
		super (item);
		if (op == null)
			...
			throw new NullPointerException
				("SharedSigned8BitIntegerReductionBuf(): op is null");
			}
		myOp = op;
		}

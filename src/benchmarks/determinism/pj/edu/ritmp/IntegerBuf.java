...
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.IntegerBuf
//
...
import benchmarks.determinism.pj.edu.ritmp.buf.EmptyIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.IntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.IntegerArrayBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.IntegerItemBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.IntegerMatrixBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.IntegerMatrixBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedIntegerArrayBuf_1;
...
// Exported operations.
	 ...
	 */
	public static IntegerBuf buffer
		(int[] theArray)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("IntegerBuf.buffer(): theArray is null");
			}
	 ...
	 */
	public static IntegerBuf sliceBuffer
		(int[] theArray,
		 Range theRange)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("IntegerBuf.sliceBuffer(): theArray is null");
			}
		int nr = Arrays.length (theArray);
		if (0 > theRange.lb() || theRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("IntegerBuf.sliceBuffer(): theArray index range = 0.." +
	 ...
	 */
	public static IntegerBuf[] sliceBuffers
		(int[] theArray,
		 Range[] theRanges)
		{
	 ...
	 */
	public static IntegerBuf rowSliceBuffer
		(int[][] theMatrix,
		 Range theRowRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("IntegerBuf.rowSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("IntegerBuf.rowSliceBuffer(): theMatrix row index range = 0.." +
	 ...
	 */
	public static IntegerBuf[] rowSliceBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges)
		{
	 ...
	 */
	public static IntegerBuf colSliceBuffer
		(int[][] theMatrix,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("IntegerBuf.colSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		int nc = Arrays.colLength (theMatrix, 0);
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("IntegerBuf.colSliceBuffer(): theMatrix column index range = 0.."
	 ...
	 */
	public static IntegerBuf[] colSliceBuffers
		(int[][] theMatrix,
		 Range[] theColRanges)
		{
	 ...
	 */
	public static IntegerBuf patchBuffer
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("IntegerBuf.patchBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("IntegerBuf.patchBuffer(): theMatrix row index range = 0.."
				 + (nr-1) + ", theRowRange = " + theRowRange);
			}
		int nc = Arrays.colLength (theMatrix, theRowRange.lb());
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("IntegerBuf.patchBuffer(): theMatrix column index range = 0.."
				 + (nc-1) + ", theColRange = " + theColRange);
			}
	 ...
	 *     <TT>theColRanges</TT>.
	 */
	public static IntegerBuf[] patchBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges,
		 Range[] theColRanges)
		{
	...
	public static IntegerBuf buffer
		...
		if (item == null)
			{
			throw new NullPointerException
				("IntegerBuf.buffer(): item is null");
			}
	...
	public void copy
		(Buf theSrc)
		{
		if (theSrc != this) defaultCopy ((IntegerBuf) theSrc, this);
		}

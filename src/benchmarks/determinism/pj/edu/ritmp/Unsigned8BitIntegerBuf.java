//******************************************************************************
//
// File:    Unsigned8BitIntegerBuf.java
// Package: benchmarks.determinism.pj.edu.ritmp
// Unit:    Class benchmarks.determinism.pj.edu.ritmp.Unsigned8BitIntegerBuf
//
...
import benchmarks.determinism.pj.edu.ritmp.buf.EmptyUnsigned8BitIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerArrayBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerItemBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerMatrixBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.Unsigned8BitIntegerMatrixBuf_1;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned8BitIntegerBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned8BitIntegerArrayBuf;
import benchmarks.determinism.pj.edu.ritmp.buf.SharedUnsigned8BitIntegerArrayBuf_1;
 ...
 * (MP). In a message, an unsigned 8-bit integer item is represented as one
 * byte. The range of values that can be represented is 0 .. 255.
 * <P>
 ...
 * <P>
 * To create an Unsigned8BitIntegerBuf, call one of the following static factory
 * methods:
 * <UL>
 ...
 * @version 03-May-2008
 */
public abstract class Unsigned8BitIntegerBuf
	extends Buf
	{
...
// Hidden constructors.
	 ...
	 */
	protected Unsigned8BitIntegerBuf
		(int theLength)
		{
...
// Exported operations.
	 ...
	 * @return  Empty buffer.
	 */
	public static Unsigned8BitIntegerBuf emptyBuffer()
		{
		return new EmptyUnsigned8BitIntegerBuf();
		}
	 ...
	 * @return  Buffer.
	 */
	public static Unsigned8BitIntegerItemBuf buffer()
		{
		return new Unsigned8BitIntegerItemBuf();
		}
	...
	public static Unsigned8BitIntegerItemBuf buffer
		(int item)
		{
		return new Unsigned8BitIntegerItemBuf (item);
		}
	 ...
	 */
	public static Unsigned8BitIntegerBuf buffer
		(int[] theArray)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.buffer(): theArray is null");
			}
		int nr = Arrays.length (theArray);
		return new Unsigned8BitIntegerArrayBuf_1 (theArray, new Range (0, nr-1));
		}
	 ...
	 */
	public static Unsigned8BitIntegerBuf sliceBuffer
		(int[] theArray,
		 Range theRange)
		{
		if (theArray == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.sliceBuffer(): theArray is null");
			}
		int nr = Arrays.length (theArray);
		if (0 > theRange.lb() || theRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned8BitIntegerBuf.sliceBuffer(): theArray index range = 0.." +
				 (nr-1) + ", theRange = " + theRange);
			}
		if (theRange.stride() == 1)
			{
			return new Unsigned8BitIntegerArrayBuf_1 (theArray, theRange);
			}
		else
			{
			return new Unsigned8BitIntegerArrayBuf (theArray, theRange);
			}
		}
	 ...
	 */
	public static Unsigned8BitIntegerBuf[] sliceBuffers
		(int[] theArray,
		 Range[] theRanges)
		{
		int n = theRanges.length;
		Unsigned8BitIntegerBuf[] result = new Unsigned8BitIntegerBuf [n];
		for (int i = 0; i < n; ++ i)
			{
	...
	public static Unsigned8BitIntegerBuf buffer
		...
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.buffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		int nc = Arrays.colLength (theMatrix, 0);
		return new Unsigned8BitIntegerMatrixBuf_1
	 ...
	 */
	public static Unsigned8BitIntegerBuf rowSliceBuffer
		(int[][] theMatrix,
		 Range theRowRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.rowSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned8BitIntegerBuf.rowSliceBuffer(): theMatrix row index range = 0.." +
		...
		if (theRowRange.stride() == 1)
			...
			{
			return new Unsigned8BitIntegerMatrixBuf
				(theMatrix, theRowRange, new Range (0, nc-1));
			}
		}
	 ...
	 */
	public static Unsigned8BitIntegerBuf[] rowSliceBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges)
		{
	 ...
	 */
	public static Unsigned8BitIntegerBuf colSliceBuffer
		(int[][] theMatrix,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.colSliceBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		int nc = Arrays.colLength (theMatrix, 0);
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("Unsigned8BitIntegerBuf.colSliceBuffer(): theMatrix column index range = 0.."
	 ...
	 */
	public static Unsigned8BitIntegerBuf[] colSliceBuffers
		(int[][] theMatrix,
		 Range[] theColRanges)
		{
	 ...
	 */
	public static Unsigned8BitIntegerBuf patchBuffer
		(int[][] theMatrix,
		 Range theRowRange,
		 Range theColRange)
		{
		if (theMatrix == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix is null");
			}
		int nr = Arrays.rowLength (theMatrix);
		if (0 > theRowRange.lb() || theRowRange.ub() >= nr)
			{
			throw new IndexOutOfBoundsException
				("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix row index range = 0.."
				 + (nr-1) + ", theRowRange = " + theRowRange);
			}
		int nc = Arrays.colLength (theMatrix, theRowRange.lb());
		if (0 > theColRange.lb() || theColRange.ub() >= nc)
			{
			throw new IndexOutOfBoundsException
				("Unsigned8BitIntegerBuf.patchBuffer(): theMatrix column index range = 0.."
				 + (nc-1) + ", theColRange = " + theColRange);
			}
		if (theRowRange.stride() == 1 && theColRange.stride() == 1)
			{
			return new Unsigned8BitIntegerMatrixBuf_1 (theMatrix, theRowRange, theColRange);
			}
		else
			{
			return new Unsigned8BitIntegerMatrixBuf (theMatrix, theRowRange, theColRange);
			}
		}
	 ...
	 *     <TT>theColRanges</TT>.
	 */
	public static Unsigned8BitIntegerBuf[] patchBuffers
		(int[][] theMatrix,
		 Range[] theRowRanges,
		 Range[] theColRanges)
		{
	...
	public static Unsigned8BitIntegerBuf buffer
		...
		if (item == null)
			{
			throw new NullPointerException
				("Unsigned8BitIntegerBuf.buffer(): item is null");
			}
		return new SharedUnsigned8BitIntegerBuf (item);
		}
	...
	public static Unsigned8BitIntegerBuf buffer
		...
		return new SharedUnsigned8BitIntegerArrayBuf_1
	...
	public static Unsigned8BitIntegerBuf sliceBuffer
		...
		if (theRange.stride() == 1)
			{
			return new SharedUnsigned8BitIntegerArrayBuf_1 (theArray, theRange);
			}
		else
			{
			return new SharedUnsigned8BitIntegerArrayBuf (theArray, theRange);
			}
		}
	...
	public void copy
		(Buf theSrc)
		{
		if (theSrc != this) defaultCopy ((Unsigned8BitIntegerBuf) theSrc, this);
		}
...
// Hidden operations.
	...
	protected static void defaultCopy
		(Unsigned8BitIntegerBuf theSrc,
		 Unsigned8BitIntegerBuf theDst)
		{

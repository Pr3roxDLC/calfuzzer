...
// Unit:    Class benchmarks.determinism.pj.edu.ritsmp.fractal.MandelbrotSetSmp
//
 ...
 * Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.determinism.pj.edu.ritsmp.fractal.MandelbrotSetSmp
...
// Main program.
	...
	public static void main
		...
		yoffset = (height - 1) / 2;
                ...
                requireDeterministic(width);
                requireDeterministic(height);
                requireDeterministic(xcenter);
                requireDeterministic(ycenter);
                requireDeterministic(resolution);
                requireDeterministic(maxiter);
                requireDeterministic(gamma);
		...
		long t3 = System.currentTimeMillis();
                ...
                assertDeterministic(matrix, new ArrayEquals());
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.determinism.pj.edu.ritsmp.fractal.MandelbrotSetSmp <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");

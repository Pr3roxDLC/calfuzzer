...
// Unit:    Class benchmarks.determinism.pj.edu.ritcompbio.phyl.test.Test04
//
...
import benchmarks.determinism.pj.edu.ritcompbio.phyl.JukesCantorDistance;
 ...
 * benchmarks.determinism.pj.edu.ritcompbio.phyl.DnaSequenceList}, {@linkplain
 * benchmarks.determinism.pj.edu.ritcompbio.phyl.DnaSequenceTree}, {@linkplain
 * benchmarks.determinism.pj.edu.ritcompbio.phyl.FitchParsimony}, and {@linkplain
 * benchmarks.determinism.pj.edu.ritcompbio.phyl.Upgma}. The program:
 * <OL TYPE=1>
 * <LI>
 ...
 * benchmarks.determinism.pj.edu.ritdraw.Drawing} object.
 * </OL>
 * <P>
 * The {@linkplain View} program can be used to view the drawing file and
 * save it in an image file in several formats.
 * <P>
 * Usage: java benchmarks.determinism.pj.edu.ritcompbio.phyl.test.Test04 <I>infile</I> <I>outfile</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java benchmarks.determinism.pj.edu.ritcompbio.phyl.test.Test04 <infile> <outfile> <drawfile> [<format>]");

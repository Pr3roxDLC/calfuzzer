...
// Unit:    Class benchmarks.determinism.pj.edu.ritpj.test.Test03
//
...
import benchmarks.determinism.pj.edu.ritpj.IntegerStrideForLoop;
 ...
 * ParallelRegion}, and {@linkplain benchmarks.determinism.pj.edu.ritpj.IntegerForLoop IntegerForLoop}.
 ...
 * benchmarks.determinism.pj.edu.ritpj.test.Test03 <I>lb</I> <I>ub</I> <I>stride</I> <I>wait</I>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<K>] [-Dpj.schedule=<schedule>] benchmarks.determinism.pj.edu.ritpj.test.Test03 <lb> <ub> <stride> <wait>");

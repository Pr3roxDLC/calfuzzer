...
// Unit:    Class benchmarks.detinfer.pj.edu.ritsmp.fractal.MandelbrotSetSmp
//
 ...
 * Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> benchmarks.detinfer.pj.edu.ritsmp.fractal.MandelbrotSetSmp
...
// Main program.
	...
	public static void main
		...
		long t3 = System.currentTimeMillis();
                ...
                closeDeterministicBlock(new String[] { "args", "t1", "t2", "t3" },
                                        new Object[] {  args,   t1,   t2,   t3 });
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.nt=<K> benchmarks.detinfer.pj.edu.ritsmp.fractal.MandelbrotSetSmp <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");

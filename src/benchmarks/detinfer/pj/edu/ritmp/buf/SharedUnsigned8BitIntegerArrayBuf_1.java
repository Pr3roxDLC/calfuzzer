//******************************************************************************
//
// File:    SharedUnsigned8BitIntegerArrayBuf_1.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.SharedUnsigned8BitIntegerArrayBuf_1
//
 ...
 * of class SharedUnsigned8BitIntegerArrayBuf_1 may be constructed directly,
 * normally you will use a factory method in class {@linkplain
 * benchmarks.detinfer.pj.edu.ritmp.Unsigned8BitIntegerBuf Unsigned8BitIntegerBuf}. See that class for
 * further information.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
public class SharedUnsigned8BitIntegerArrayBuf_1
...
// Exported constructors.
	 ...
	 */
	public SharedUnsigned8BitIntegerArrayBuf_1
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedUnsigned8BitIntegerArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int receiveItems
		...
		while (index < max && buffer.remaining() >= 1)
			{
			myArray.set (off, buffer.get() & 0xFF);
			++ index;
			++ off;
			}
		return index - i;

//******************************************************************************
//
// File:    SharedShortArrayReductionBuf_1.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.SharedShortArrayReductionBuf_1
//
...
/**
 * Class SharedShortArrayReductionBuf_1 provides a reduction buffer for
 * class {@linkplain SharedShortArrayBuf_1}.
 *
 * @author  Alan Kaminsky
 * @version 26-Oct-2007
 */
class SharedShortArrayReductionBuf_1
	extends SharedShortArrayBuf_1
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared short array reduction buffer.
	 *
	 ...
	 */
	public SharedShortArrayReductionBuf_1
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedShortArrayReductionBuf_1(): op is null");
			}
		myOp = op;
		}

//******************************************************************************
//
// File:    SharedShortArrayBuf_1.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.SharedShortArrayBuf_1
//
 ...
 * SharedShortArrayBuf_1 may be constructed directly, normally you will use
 * a factory method in class {@linkplain benchmarks.detinfer.pj.edu.ritmp.ShortBuf ShortBuf}.
...
// Exported operations.
	...
	public Buf getReductionBuf
		(Op op)
		{
		return new SharedShortArrayReductionBuf_1
...
// Hidden operations.
	...
	protected int sendItems
		...
		while (index < myLength && buffer.remaining() >= 2)
			{
			buffer.putShort (myArray.get (off));
			++ index;
			++ off;
			}
		return index - i;

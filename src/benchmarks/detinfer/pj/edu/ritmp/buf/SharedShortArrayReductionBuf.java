//******************************************************************************
//
// File:    SharedShortArrayReductionBuf.java
// Package: benchmarks.detinfer.pj.edu.ritmp.buf
// Unit:    Class benchmarks.detinfer.pj.edu.ritmp.buf.SharedShortArrayReductionBuf
//
...
/**
 * Class SharedShortArrayReductionBuf provides a reduction buffer for class
 * {@linkplain SharedShortArrayBuf}.
 *
...
// Exported constructors.
	 ...
	 */
	public SharedShortArrayReductionBuf
		...
		if (op == null)
			...
			throw new NullPointerException
				("SharedShortArrayReductionBuf(): op is null");
			}
		myOp = op;
		}

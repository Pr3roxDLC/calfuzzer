...
// Unit:    Class benchmarks.detinfer.pj.edu.ritcompbio.phyl.PhylogenyParsBnbSmp
//
 ...
 * benchmarks.detinfer.pj.edu.ritcompbio.phyl.PhylogenyParsBnbSmp <I>infile</I> <I>outdir</I>
 * [ <I>N</I> [ <I>T</I> ] ]
...
// Main program.
	...
	public static void main
		...
		seqList.truncate (N);
                ...
                openDeterministicBlock(new String[] { "args", "t1" },
                                       new Object[] {  args,   t1 });
		...
		long t3 = System.currentTimeMillis();
                ...
                closeDeterministicBlock
                    (new String[] { "args", "t1", "upgmaTree", "upgmaScore", "uninformativeScore", "t2", "t3" },
                     new Object[] {  args,   t1,   upgmaTree,   upgmaScore,   uninformativeScore,   t2,   t3  });

		// Report results.
		Results.report
			(/*directory      */ outdir,
			 /*programName    */ "benchmarks.detinfer.pj.edu.ritcompbio.phyl.PhylogenyParsBnbSmp",
			 /*hostName       */ "localhost",
			 /*K              */ K,
			 /*infile         */ infile,
	...
	private static void usage()
		{
		System.err.println ("Usage: java [-Dpj.nt=<Kt>] [-Dpj.schedule=<schedule>] benchmarks.detinfer.pj.edu.ritcompbio.phyl.PhylogenyParsBnbSmp <infile> <outdir> [<N> [<T>]]");
